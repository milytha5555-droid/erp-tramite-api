# APK ERP g&f para tablet Android
...
```text
https://erp-tramite-api.onrender.com/
```

Esa URL sirve para probar desde cualquier red porque apunta al deploy publico de Render.

Para pruebas locales desde una tablet conectada por USB, puedes cambiar `APP_URL` temporalmente a:
